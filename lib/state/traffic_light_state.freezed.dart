...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TrafficLightState&&(identical(other.trafficLight, trafficLight) || other.trafficLight == trafficLight));
}


@override
int get hashCode => Object.hash(runtimeType,trafficLight);

@override
String toString() {
  return 'TrafficLightState(trafficLight: $trafficLight)';
}
...
/// Create a copy of TrafficLightState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? trafficLight = null,}) {
  return _then(TrafficLightState(
trafficLight: null == trafficLight ? _self.trafficLight : trafficLight // ignore: cast_nullable_to_non_nullable
as TrafficLight,
  ));
}
